...
export default function Donations() {
  return (
    <div className="pt-28">
      <h1 className="flex items-center justify-center text-3xl font-bold mb-3">
        Support the Cause: Your Contribution Makes a Difference
      </h1>
      <p className="flex items-center justify-center">
        Your genorsity can change lives. Every peny you donate goes directly to
        funding mental health treatments for those in need.{" "}
      </p>
          ...
          <div className="flex flex-row items-center justify-center w-full">
            <div className="flex basis-1/2 flex-col items-center justify-between gap-6">
              <div className="grid gird-cols-2">
                ...
                <input
                  type="text"
                  className="p-2 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2
                       focus:ring-blue-500"
                />
              </div>
              <div className="grid gird-cols-2">
